const variantClasses = {
  ...
  neon:    'bg-neon-cyan/10 text-neon-cyan border border-neon-cyan/40 shadow-neon-cyan',
  ai:      'bg-gradient-to-r from-neon-violet/20 to-brand-500/20 text-brand-300 border border-neon-violet/40 shadow-neon-violet',
  ...
  gold:    'bg-rank-gold/10 text-rank-gold border border-rank-gold/40 shadow-rank-gold',
  platinum:'bg-rank-platinum/10 text-rank-platinum border border-rank-platinum/40',
  diamond: 'bg-rank-diamond/10 text-rank-diamond border border-rank-diamond/40 shadow-rank-diamond',
  master:  'bg-rank-master/10 text-rank-master border border-rank-master/40 shadow-rank-master',
  grandmaster: 'bg-gradient-to-r from-rank-grandmaster/20 to-rank-gold/20 text-rank-gold border border-rank-grandmaster/50 shadow-rank-gold',
};
