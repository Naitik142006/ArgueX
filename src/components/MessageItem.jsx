...
export default function MessageItem({
 ...
 ${isOwn ?'bg-brand-600 text-white rounded-2xl rounded-tr-sm' :'bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700/60 text-zinc-900 dark:text-zinc-100 rounded-2xl rounded-tl-sm'
 }`}
 >
 {isEditing ? (
