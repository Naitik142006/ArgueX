...
export default function ReplayPage() {
 ...
 <Badge variant="neon" className="bg-rose-500/10 text-rose-400 border-rose-500/20 py-0.5">
 ...
 <MessageItem key={msg._id || index} message={{...msg, isAi: msg.senderRole ==='ai'}} index={index} hideActions={true} />
 ))}
 ...
 <Trophy size={28} className={analysis.winner ==='user' ?'text-emerald-400 drop-' :'text-amber-400 drop-'} />
 </div>
