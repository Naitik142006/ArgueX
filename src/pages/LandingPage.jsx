...
export default function LandingPage() {
 ...
 <Badge variant="neon" className="px-4 py-1.5 rounded-full text-sm">
 ...
 className="mt-20 relative max-w-5xl mx-auto w-full aspect-video rounded-3xl border border-white/10 glass-panel overflow-hidden flex items-center justify-center bg-surface"
 >
 ...
 <div className="self-end max-w-[90%] p-4 rounded-2xl rounded-tr-sm bg-surface border border-neon-cyan/20">
 ...
 <Link to="/signup">
 <Button size="xl" variant="brand" className="px-12 py-6 text-xl hover:">
 Create Free Account
 </Button>
 </Link>
 </div>
