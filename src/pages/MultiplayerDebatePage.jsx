...
export default function MultiplayerDebatePage() {
 ...
 <div className="w-20 h-20 rounded-3xl bg-surface border border-white/5 flex items-center justify-center text-brand-400 mb-6 relative z-10 overflow-hidden">
 ...
 <div className="bg-brand-500/10 border border-brand-500/20 rounded-2xl p-4 relative overflow-hidden">
 ...
 className="w-full gap-3 font-heading font-bold uppercase tracking-widest" onClick={handleConcludeAndJudge}
