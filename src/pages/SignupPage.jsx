    ...
    <div className="min-h-[calc(100vh-80px)] flex flex-row-reverse animate-fade-in bg-background">
      ...
      <div className="hidden lg:flex flex-1 flex-col justify-between bg-surface relative overflow-hidden p-12 border-l border-white/5 shadow-glass">
        ...
        <div className="relative z-10 max-w-md ml-auto text-right">
          <div className="w-16 h-16 bg-brand-500/10 rounded-2xl flex items-center justify-center mb-8 backdrop-blur-md border border-brand-500/20 shadow-neon-blue ml-auto">
            <Fingerprint className="text-neon-violet" size={32} />
          </div>
          <h2 className="text-5xl font-heading font-black text-white uppercase tracking-tight leading-tight mb-6 drop-shadow-md">
        ...
        <div className="relative z-10 text-right">
          ...
          <div className="flex items-center justify-end gap-4">
            ...
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-brand-500 to-neon-violet p-[2px] shadow-[0_0_15px_rgba(139,92,246,0.4)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4">
              <Button
                ...
                variant="brand"
                size="lg"
                className="w-full shadow-neon-blue font-heading font-bold tracking-widest text-sm"
                loading={isLoading}
              >
                REGISTER COMBATANT
              </Button>
