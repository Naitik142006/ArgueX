...
export default function LeaderboardPage() {
 ...
 if (index === 0) return { glow:'', text:'text-yellow-400', bg:'bg-yellow-500/10', border:'border-yellow-500/30' };
 if (index === 1) return { glow:'', text:'text-zinc-300', bg:'bg-zinc-400/10', border:'border-zinc-400/30' };
 if (index === 2) return { glow:'', text:'text-amber-500', bg:'bg-amber-600/10', border:'border-amber-600/30' };
 ...
 Gold: { style:'bg-yellow-950/40 text-yellow-400 border-yellow-500/30' },
 Platinum: { style:'bg-teal-950/40 text-teal-400 border-teal-500/30' },
 Diamond: { style:'bg-blue-950/40 text-blue-400 border-blue-500/30' },
 Master: { style:'bg-purple-950/40 text-purple-400 border-purple-500/30' },
 Grandmaster: { style:'bg-rose-950/40 text-rose-400 border-rose-500/30' }
 };
 ...
 <Card className={`bg-surface border relative overflow-hidden group transition-all duration-300 hover:-translate-y-1 ${style.border}`}>
 {/* Hover Effect */}
 ...
 {user.username}
 {index === 0 && <Medal className="w-5 h-5 text-yellow-400 drop-" />}
 ...
 <TrendingUp size={12} className="text-emerald-500" /> <span className="text-white">{user.wins}</span>W - <span className="text-zinc-400">{user.losses}</span>L
 </span>
 ...
 <TrendingUp size={14} className="text-emerald-500" /> <span className="text-white">{user.wins}</span> Wins / <span className="text-zinc-400">{user.losses}</span> Losses
 </span>
 {user.currentStreak > 2 ? (
