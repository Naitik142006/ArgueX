...
export default function ProfilePage() {
 ...
 {/* Banner */}
 <div className="absolute top-0 left-0 w-full h-40 bg-gradient-to-r from-brand-900 via-brand-800/50 to-background border-b border-white/10 overflow-hidden">
 ...
 <div className="p-1.5 bg-surface border border-white/10 rounded-full relative z-10">
 ...
 <Badge variant="neon" className="mx-auto sm:mx-0 py-0.5">
 ...
 <Card className={`text-center glass-panel border ${stat.border} group hover:-translate-y-1 transition-all duration-300`}>
 ...
 <p className="text-4xl font-heading font-bold text-white mb-2">{stat.value}</p>
